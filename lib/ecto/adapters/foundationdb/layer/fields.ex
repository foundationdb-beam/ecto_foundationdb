defmodule Ecto.Adapters.FoundationDB.Layer.Fields do
  ...
  ## Examples
    ...
    iex> Ecto.Adapters.FoundationDB.Layer.Fields.parse_select_fields([{{:., [], [{:&, [], [0]}, :a]}, [], []}])
    [:a]
  ...
  ## Examples
    ...
    iex> Ecto.Adapters.FoundationDB.Layer.Fields.strip_field_names_for_ecto([[a: 0, b: 1, c: 2]])
    [[0,1,2]]
  ...
  ## Examples
    ...
    iex> Ecto.Adapters.FoundationDB.Layer.Fields.to_front([a: 0, b: 1, c: 2], :c)
    [c: 2, a: 0, b: 1]
