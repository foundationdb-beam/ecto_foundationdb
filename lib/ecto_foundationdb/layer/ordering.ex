defmodule EctoFoundationDB.Layer.Ordering do
  ...
  """
  def get_query_ordering(_schema, []), do: {[], &Function.identity/1}
  def get_query_ordering(_schema, nil), do: {[], &Function.identity/1}

  def get_query_ordering(schema, ordering) do
